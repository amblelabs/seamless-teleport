...
public class STPModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ClientPlayNetworking.registerGlobalReceiver(STPMod.TP, (client, handler, buf, response) -> {
        ...
        ClientPlayNetworking.registerGlobalReceiver(STPMod.PRELOAD, (client, handler, buf, responseSender) -> {
        ...
        ClientPlayNetworking.registerGlobalReceiver(STPMod.UNLOAD, (client, handler, buf, responseSender) -> {
            Identifier id = buf.readIdentifier();
